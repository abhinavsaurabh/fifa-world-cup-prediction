...
def generate_team_stats():
    ...
    processed_data.to_csv('WC18_processed.csv',encoding='latin-1')
...
def generate_prior_data(stats):
    ...
    processed_data.to_csv('WC18_prior.csv',encoding='latin-1')
...
if __name__ == '__main__':
    ...
    prior = pd.read_csv('resultsproject3.csv',encoding='latin-1')
    fifa_dataset = pd.read_csv('CompleteDataset.csv',encoding='latin-1')
